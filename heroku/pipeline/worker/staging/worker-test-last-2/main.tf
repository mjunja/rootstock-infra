# =============================================================================
# worker-test-last-2 - Heroku Application
# =============================================================================
...
module "app" {
  ...
  config_vars = {
    ...
    aphria_sit_finance_araging_APP_NAME                                   = "finreport-test-last-2"
    aphria_sit_finance_araging_ONEOFF_DYNO_TYPE                           = "performance-l"
    aphria_sit_finance_araging_PROCFILE_PROCESS_NAME                      = "newoneoff"
    aphria_sit_finance_araging_aragingreport_APP_NAME                     = "finreport-test-last-2"
    ...
    aphria_uat_finance_araging_APP_NAME                                   = "finreport-test-last-2"
    aphria_uat_finance_araging_ONEOFF_DYNO_TYPE                           = "performance-l"
    aphria_uat_finance_araging_PROCFILE_PROCESS_NAME                      = "newoneoff"
    aphria_uat_finance_araging_aragingreport_APP_NAME                     = "finreport-test-last-2"
