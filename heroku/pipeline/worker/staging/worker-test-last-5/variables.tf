# =============================================================================
# worker-test-last-5 - Sensitive inputs
# =============================================================================
...
variable "cloudamqp_apikey" {
  description = "CloudAMQP API key (manually set - no cloudamqp add-on attached)"
  type        = string
  sensitive   = true
}

variable "cloudamqp_url" {
  description = "CloudAMQP connection URL (manually set - no cloudamqp add-on attached)"
  type        = string
  sensitive   = true
}
