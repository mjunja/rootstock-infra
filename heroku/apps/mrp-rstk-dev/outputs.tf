...
output "app_id" {
  ...
  value       = heroku_app.mrp_rstk_dev.id
}

output "app_name" {
  description = "The Heroku app name"
  value       = heroku_app.mrp_rstk_dev.name
}

output "web_url" {
  description = "The web URL of the app"
  value       = heroku_app.mrp_rstk_dev.web_url
}

output "git_url" {
  description = "The Git URL for deploying to this app"
  value       = heroku_app.mrp_rstk_dev.git_url
}

output "heroku_hostname" {
  description = "The hostname for the app"
  value       = heroku_app.mrp_rstk_dev.heroku_hostname
}
...
output "pipeline_stage" {
  ...
  value       = heroku_pipeline_coupling.mrp_rstk_dev.stage
}
